...
class GetUserProfileHandler(tornado.web.RequestHandler):
    def get(self, *args, **kwargs):
        ...
        cursor.execute("SELECT a.username,b.avatar,b.sex,b.birthday,b.qq,b.register_date,b.last_login_date,b.game_time,b.win_time FROM user AS a LEFT JOIN user_info AS b ON a.user_id=b.user_id WHERE a.username=%s",username)
        returnResult={}
        content={}
        row=cursor.fetchone()
